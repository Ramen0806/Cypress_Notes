...
Cypress.Commands.add('haveText',{prevSubject: true}, (subject, expectedText) =>{
 ...
 //Create a cypress child custom command
 //that validate any given attribute, and any given value

 Cypress.Commands.add('validate',{prevSubject: true}, (subject, attr , value ) =>{
